...
pub struct PlanToGraphVisitor<'a> {
...
impl<'a> Planner<'a> {
    ...
    #[inline]
    pub fn keyed_aggregate_parallelism(&self) -> usize {
    ...
    pub fn sync_plan(&self, plan: &LogicalPlan) -> Result<Arc<dyn ExecutionPlan>> {
...
impl PlanToGraphVisitor<'_> {
    ...
    pub fn add_plan(&mut self, plan: LogicalPlan) -> Result<()> {
