...
use crate::common::constants::{extension_node, proto_operator_name, updating_state_field};
...
pub const CONTINUOUS_AGGREGATE_NODE_NAME: &str = extension_node::CONTINUOUS_AGGREGATE;
...
pub struct ContinuousAggregateNode {
