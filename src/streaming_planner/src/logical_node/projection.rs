...
use protocol::function_stream_graph::ProjectionOperator;

use crate::multifield_partial_ord;
use crate::common::constants::{extension_node, sql_field};
...
use crate::types::{QualifiedField, build_df_schema};

// -----------------------------------------------------------------------------
// Constants & Identifiers
// -----------------------------------------------------------------------------

pub const STREAM_PROJECTION_NODE_NAME: &str = extension_node::STREAM_PROJECTION;
...
pub struct StreamProjectionNode {
...
impl StreamProjectionNode {
    ...
    pub fn with_shuffle_routing(mut self) -> Self {
