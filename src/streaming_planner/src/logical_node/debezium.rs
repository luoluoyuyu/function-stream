...
pub const UNROLL_NODE_NAME: &str = extension_node::UNROLL_DEBEZIUM_PAYLOAD;
pub const PACK_NODE_NAME: &str = extension_node::PACK_DEBEZIUM_ENVELOPE;
...
pub struct DebeziumSchemaCodec;
...
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct PackDebeziumEnvelopeNode {
...
impl PackDebeziumEnvelopeNode {
    pub fn try_new(upstream_plan: LogicalPlan) -> Result<Self> {
