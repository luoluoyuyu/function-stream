...
use protocol::function_stream_graph::{FilesystemSinkConfig, SinkFormatProto};
...
pub struct FilesystemSinkConnector;

impl SinkProvider for FilesystemSinkConnector {
    ...
    fn build_sink_config(
        ...
        Ok(ConnectorConfig::FilesystemSink(FilesystemSinkConfig {
            path,
            format: format_proto,
            parquet_compression,
            extra_properties,
